        ...
        <div v-if="overview != null" class="overview">
            <div class="summary-cards">
                ...
                <Card class="summary-card" v-if="overview.users" style="max-width: 50rem;">
                    <template #content>
                        <Carousel :value="Object.keys(overview.users)" :num-visible="1" circular :autoplay-interval="4000">
                            <template #item="slotProps">
                                ...
                                <div class="carousel-item">
                                    ...
                                    <b v-if="overview.users[slotProps.data].all_time_change[0] == '-'"
                                    ...
                                    <Divider layout="vertical" class="hdiv" />
                                    <Divider layout="horizontal" class="vdiv" />
                                    <span>{{ overview.users[slotProps.data].last_snapshot.toLocaleDateString() }}</span>
                                </div>
                            </template>
                        </Carousel>
                    </template>
