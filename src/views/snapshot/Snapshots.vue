...
<template>
    <div>
        ...
        <DataTable :value="snapshots" :loading="loading">
            ...
            <Column v-for="[key, display] in Object.entries(headings)" :key="key" :field="key" :header="display" sortable>
            </Column>
            <Column header="Actions">
                <template #body="slotProps">
                    <Button icon="pi pi-trash" severity="danger" @click="deleteSnapshotButton($event, slotProps.data.id)" />
                </template>
            </Column>
        </DataTable>
    </div>
